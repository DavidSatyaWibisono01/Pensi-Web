  ...
  <body>
    ...
    <section class="about" id="about">
      <div class="title reveal">
        <h2 class="section-title">PPLG</h2>
      </div>
      <div class="content">
      	<div class="img-box">
    ...
    <section class="work" id="work">
      ...
      <div class="content">
        <div class="card reveal">
          <div class="card-img">
            <img src="pplg/work1.jpg" alt="">
          </div>
        </div>
        <div class="card reveal">
          <div class="card-img">
            <img src="pplg/work2.jpg" alt="">
          </div>
        </div>
        <div class="card reveal">
          <div class="card-img">
            <img src="pplg/work3.jpg" alt="">
          </div>
        </div>
        <div class="card reveal">
          <div class="card-img">
            <img src="pplg/work4.jpg" alt="">
          </div>
        </div>
        <div class="card reveal">
          <div class="card-img">
            <img src="pplg/work5.jpg" alt="">
          </div>
        </div>
        <div class="card reveal">
          <div class="card-img">
            <img src="pplg/work6.jpg" alt="">
          </div>
        </div>
        <div class="title reveal">
