...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 20 Apr 2022 pada 18.02
...
(3, '2022_02_23_092109_create_pengunjungs_table', 1),
(4, '2022_03_21_223400_create_instansis_table', 1),
(5, '2022_03_26_173519_create_trackings_table', 1),
(6, '2022_03_30_101230_create_pesans_table', 1);
...
CREATE TABLE `pengunjungs` (
  ...
  `status` enum('active','tidak active') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `pesans` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `pengunjung_id` bigint(20) NOT NULL,
...
CREATE TABLE `trackings` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `pengunjung_id` bigint(20) NOT NULL,
  `pplg` datetime DEFAULT NULL,
  `dkv` datetime DEFAULT NULL,
  `tjkt` datetime DEFAULT NULL,
  `pmn` datetime DEFAULT NULL,
  `hotel` datetime DEFAULT NULL,
  `mplb` datetime DEFAULT NULL,
  `kuliner` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'admin', '$2y$10$u0m5ujX/fwAF4BlYqAiuXObOwvZoamsFJfuMWnGHFYqJqe5Hjo3Ri', '2022-04-20 16:01:52', '2022-04-20 16:01:52');
