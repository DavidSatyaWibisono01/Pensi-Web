  ...
  <body id="body" data-spy="scroll" data-target=".navbar" data-offset="100">
    ...
    <section class="about">
      <div class="title reveal">
        <h2 class="section-title" id="virtual-tour">Pemasaran</h2>
      </div>
      <div class="content">
      	<div class="img-box">
